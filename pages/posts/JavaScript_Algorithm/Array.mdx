...
속성/요소	설명	예시
input
Read only	정규표현식 일치 대상이 된 원본 문자열입니다.	"cdbBdbsbz"
index
Read only	일치가 위치한 원본 문자열에서의 인덱스입니다.	1
[0]
Read only	마지막으로 일치한 텍스트입니다.	"dbBd"
[1], ...[n]
Read only	존재할 경우, 정규표현식에서 괄호로 지정한 부분문자열 일치에 대응하는 요소입니다. 가능한 수의 제한은 없습니다.	[1]: "bB"
[2]: "d"
배열 복사하기
