...
function solution(want, number, discount) {
    ...
    for(let i=0;i<discount.length;i++){
        const nowDiscountList = discount.slice(i,i+10).sort();
        if(wantList.every((a,i)=> a===nowDiscountList[i])){
            answer++;
        }
    }
    return answer;
...
채점을 시작합니다.
정확성  테스트
테스트 1 〉	통과 (12.09ms, 37.2MB)
테스트 2 〉	통과 (53.36ms, 40MB)
테스트 3 〉	통과 (17.82ms, 37.5MB)
테스트 4 〉	통과 (48.12ms, 39.5MB)
테스트 5 〉	통과 (35.36ms, 40MB)
테스트 6 〉	통과 (13.49ms, 38.1MB)
테스트 7 〉	통과 (20.49ms, 38.8MB)
테스트 8 〉	통과 (73.58ms, 42MB)
테스트 9 〉	통과 (16.22ms, 38.7MB)
테스트 10 〉	통과 (41.08ms, 39.5MB)
테스트 11 〉	통과 (13.02ms, 37.3MB)
